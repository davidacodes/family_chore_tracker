...
urlpatterns = [
    ...
    path("setup/kids/<int:kid_id>/edit/", views.edit_kid, name="edit_kid"),
    path("setup/kids/<int:kid_id>/delete/", views.delete_kid, name="delete_kid"),
    path("setup/chores/", views.setup_chores, name="setup_chores"),
    path("setup/chores/<int:chore_id>/edit/", views.edit_chore, name="edit_chore"),
    path("setup/chores/<int:chore_id>/delete/", views.delete_chore, name="delete_chore"),
